...
echo ============================================
echo   DESTROY QA — billable resources only
echo   (iam / ecr / storage are left running — free)
echo ============================================
echo.
set /p CONFIRM="Type YES to destroy QA's networking/database/ecs-service/monitoring/notifications: "
